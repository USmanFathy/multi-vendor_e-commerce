...
@section('content')
    ...
    <form action="{{route('dashboard.profile.update')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="col-md-6">
                <x-form.checkbox name="gender" label="Gender" :options="['male'=>'Male','female'=>'Female']" :checked="$user->profile->gender"/>
            </div>
        </div>
        <div class="form-row">
            <div class="col-md-4">
        ...
        <div class="form-row">
            ...
            <div class="col-md-4">
                <x-form.select name="local" label="Local" :options="$locals" :selected="$user->profile->local"/>
