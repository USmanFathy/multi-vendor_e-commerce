                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="address[billing][street_address]"  placeholder="Mailing Address"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <x-form.input name="address[billing][state]"  placeholder="State"/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>Mailing Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[shipping][street_address]"  placeholder="Mailing Address"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>City</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[shipping][city]"  placeholder="City"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Region/State</label>
                                                    <div class="select-items">
                                                        <x-form.input name="address[shipping][state]"  placeholder="State"/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.select name="address[shipping][country]"  :options="$countries" selected=""/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
